  ...
  try {
    ...
    switch(loginData.status) {
      ...
      case status.OK:
        ...
        res.cookie(process.env.COOKIES_NAME, token, { maxAge: config.tokenExpiration, httpOnly: false  });
...
router.get('/logged_in', async (req, res) => {
  try {
    ...
    res.cookie(process.env.COOKIES_NAME, newTokneGen, { maxAge: config.tokenExpiration, httpOnly: false  });
